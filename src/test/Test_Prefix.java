...
public class Test_Prefix {
	...
	@Parameters(name = "prefix_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"prefix_0"},
												{a2,"prefix_1"},
												{a3,"prefix_2"},
												{a4,"prefix_3"},
												{a5,"prefix_4"},
	...
	@Test
	public final void test_Prefix() throws IOException, ClassCastException, ClassNotFoundException {
