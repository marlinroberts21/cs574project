...
public class Test_Union {
  ...
  @Parameters(name = "union_{index}")
  public static Collection<Object[]> parms() throws Exception {
    setUpBeforeClass();
    return Arrays.asList(
        new Object[][] {
          {a_min_min_n, a_min_med_y, "union_0"},
          {a_min_max_y, a_med_min_n, "union_1"},
          {a_med_med_y, a_med_max_n, "union_2"}
        });
  }
  ...
  @Test
  public final void test_Replace5() throws IOException, ClassCastException, ClassNotFoundException {
