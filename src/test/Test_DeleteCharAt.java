...
public class Test_DeleteCharAt {
	...
	@Parameters(name = "deletecharat_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"deletecharat_0"},
												{a2,"deletecharat_1"},
												{a3,"deletecharat_2"},
												{a4,"deletecharat_3"},
												{a5,"deletecharat_4"},
	...
	@Test
	public final void test_DeleteCharAt() throws IOException, ClassCastException, ClassNotFoundException {
		...
		UnaryOperation operation  = new DeleteCharAt();
