...
public class Test_Contains {
	...
	public static Collection<Object[]> parms() throws Exception {
		...
		return Arrays.asList(new Object[][]{	{a1,a1b,"contains_0",BINARY_TRUE},
	...
	public final void test_Contains() throws IOException, ClassCastException, ClassNotFoundException {
		...
		assertTrue("ASSERT FAIL: -contains operation failed", b1.getShortestExample(true).charAt(0) == RESULT);
		...
		if (TEST_STRING_RESULTS) {
			assertTrue("ASSERT FAIL: -string operation inconsistent with previous results", (b1.equals(loadAutomaton(testDir + testName))));
		}
