...
public class Test_ToUpperCase {
	...
	@Parameters(name = "touppercase_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"touppercase_0"},
												{a2,"touppercase_1"},
												{a3,"touppercase_2"},
												{a4,"touppercase_3"},
												{a5,"touppercase_4"},
	...
	@Test
	public final void test_ToUpperCase() throws IOException, ClassCastException, ClassNotFoundException {
