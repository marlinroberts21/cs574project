...
public class Test_SetCharAt2 {
	...
	@Parameters(name = "setcharat2_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"setcharat2_0"},
												{a2,"setcharat2_1"},
												{a3,"setcharat2_2"},
												{a4,"setcharat2_3"},
												{a5,"setcharat2_4"},
	...
	@Test
	public final void test_SetCharAt2() throws IOException, ClassCastException, ClassNotFoundException {
		...
		UnaryOperation operation  = new SetCharAt2();
