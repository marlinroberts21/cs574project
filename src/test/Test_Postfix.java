...
public class Test_Postfix {
	...
	@Parameters(name = "postfix_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"postfix_0"},
												{a2,"postfix_1"},
												{a3,"postfix_2"},
												{a4,"postfix_3"},
												{a5,"postfix_4"},
	...
	@Test
	public final void test_Postfix() throws IOException, ClassCastException, ClassNotFoundException {
