...
public class Test_SetLength {
	...
	@Parameters(name = "setlength_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"setlength_0"},
												{a2,"setlength_1"},
												{a3,"setlength_2"},
												{a4,"setlength_3"},
												{a5,"setlength_4"},
	...
	@Test
	public final void test_SetLength() throws IOException, ClassCastException, ClassNotFoundException {
		...
		UnaryOperation operation  = new SetLength();
