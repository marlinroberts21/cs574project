...
public class Test_Intersect {
  ...
  @Parameters(name = "intersect_{index}")
  public static Collection<Object[]> parms() throws Exception {
    setUpBeforeClass();
    return Arrays.asList(
        new Object[][] {
          {a_min_min_n, a_min_med_y, "intersect_0"},
          {a_min_max_y, a_med_min_n, "intersect_1"},
          {a_med_med_y, a_med_max_n, "intersect_2"}
        });
  }
  ...
  @Test
  public final void test_Intersect() throws IOException, ClassCastException, ClassNotFoundException {
