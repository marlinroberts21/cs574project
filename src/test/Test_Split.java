...
public class Test_Split {
	...
	@Parameters(name = "split_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"split_0"},
												{a2,"split_1"},
												{a3,"split_2"},
												{a4,"split_3"},
												{a5,"split_4"},
	...
	@Test
	public final void test_Split() throws IOException, ClassCastException, ClassNotFoundException {
		...
		UnaryOperation operation  = new Split();
