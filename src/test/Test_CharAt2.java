...
public class Test_CharAt2 {
	...
	@Parameters(name = "charat2_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"charat2_0"},
												{a2,"charat2_1"},
												{a3,"charat2_2"},
												{a4,"charat2_3"},
												{a5,"charat2_4"},
	...
	@Test
	public final void test_CharAt2() throws IOException, ClassCastException, ClassNotFoundException {
