...
public class Test_ToLowerCase {
	...
	@Parameters(name = "tolowercase_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"tolowercase_0"},
												{a2,"tolowercase_1"},
												{a3,"tolowercase_2"},
												{a4,"tolowercase_3"},
												{a5,"tolowercase_4"},
	...
	@Test
	public final void test_ToLowerCase() throws IOException, ClassCastException, ClassNotFoundException {
