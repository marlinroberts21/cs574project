...
public class Test_Reverse {
	...
	@Parameters(name = "reverse_{index}")
	public static Collection<Object[]> parms() throws Exception {
		setUpBeforeClass();
		return Arrays.asList(new Object[][]{	{a1,"reverse_0"},
												{a2,"reverse_1"},
												{a3,"reverse_2"},
												{a4,"reverse_3"},
												{a5,"reverse_4"},
	...
	@Test
	public final void test_Reverse() throws IOException, ClassCastException, ClassNotFoundException {
